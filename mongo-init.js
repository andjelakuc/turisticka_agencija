...
db.Korisnici.insertOne(
    {
        korisnickoIme: "dana123",
        lozinka: "danicadanica",
        privilegija: "staff"
    }
)
...
lokacije =
    [
        ...
        },
        {
            ...
            drzava: "Italija",
            kontinent: "Evropa",
            fotografija: "../assets/verona.jpeg"
        },{
            naziv: "Firenca",
            drzava: "Italija",
            kontinent: "Evropa",
            fotografija: "../assets/firenca.jpg"
        },{
            naziv: "Piza",
            drzava: "Italija",
            kontinent: "Evropa",
            fotografija: "../assets/piza.jpg"
        },{
            naziv: "Milano",
            drzava: "Italija",
            kontinent: "Evropa",
            fotografija: "../assets/milano.jpg"
        },{
            naziv: "Paris",
            drzava: "Francuska",
            kontinent: "Evropa",
            fotografija: "../assets/paris.jpg"
        },{
            naziv: "Strazburg",
            drzava: "Francuska",
            kontinent: "Evropa",
            fotografija: "../assets/strazburg.jpg"
        },{
            naziv: "London",
            drzava: "Ujedinjena Kraljevstva",
            kontinent: "Evropa",
            fotografija: "../assets/london.jpg"
        },{
            naziv: "Tokio",
            drzava: "Japan",
            kontinent: "Azija",
            fotografija: "../assets/tokio.jpg"
        },{
            naziv: "Hawaii",
            drzava: "Sjedinjene Američke Države",
            kontinent: "Severna Amerika",
            fotografija: "../assets/havaji.jpg"
        },{
            naziv: "Helsinki",
            drzava: "Finska",
            kontinent: "Evropa",
            fotografija: "../assets/helsinki.jpg"
        },{
            naziv: "Šangaj",
            drzava: "Kina",
            kontinent: "Azija",
            fotografija: "../assets/sangaj.jpg"
        },{
            naziv: "Las Vegas",
            drzava: "Sjedinjene Američke Države",
            kontinent: "Severna Amerika",
            fotografija: "../assets/lasvegas.jpg"
        },{
            naziv: "Jerusalem",
            drzava: "Izrael",
            kontinent: "Azija",
            fotografija: "../assets/jerusalem.jpg"
        },{
            naziv: "Singapur",
            drzava: "Singapur",
            kontinent: "Azija",
            fotografija: "../assets/singapur.jpg"
        },{
            naziv: "Seul",
            drzava: "Južna Koreja",
            kontinent: "Azija",
            fotografija: "../assets/seul.jpg"
        },{
            naziv: "Milano",
            drzava: "Italija",
            kontinent: "Evropa",
            ...
            drzava: "Rusija",
            kontinent: "Azija",
            fotografija: "../assets/moskva.jpg"
        },{
            naziv: "Lima",
            drzava: "Peru",
            kontinent: "Južna Amerika",
            fotografija: "../assets/lima.jpg"
        },{
            naziv: "Peking",
            drzava: "Kina",
            kontinent: "Azija",
            fotografija: "../assets/peking.jpg"
        },{
            naziv: "Edinburg",
            drzava: "Ujedinjena Kraljevstva",
            kontinent: "Evropa",
            fotografija: "../assets/edinburg.jpg"
        },{
            naziv: "Los Angeles",
            drzava: "Sjedinjene Američke Države",
            kontinent: "Severna Amerika",
            fotografija: "../assets/losandjeles.jpg"
        },{
            naziv: "Kopenhagen",
            drzava: "Danska",
            kontinent: "Evropa",
            fotografija: "../assets/kopenhagen.jpg"
        },{
            naziv: "Mumbaj",
            drzava: "Indija",
            kontinent: "Azija",
            fotografija: "../assets/mumbaj.jpg"
        },{
            naziv: "Minhen",
            drzava: "Nemačka",
            kontinent: "Evropa",
            fotografija: "../assets/minhen.jpg"
        },{
            naziv: "Hong Kong",
            drzava: "Kina",
            kontinent: "Azija",
            fotografija: "../assets/hongkong.jpg"
        },{
            naziv: "Oslo",
            drzava: "Norveška",
            kontinent: "Evropa",
            fotografija: "../assets/oslo.jpg"
        },{
            naziv: "Atina",
            drzava: "Grčka",
            kontinent: "Evropa",
            fotografija: "../assets/atina.jpg"
        },{
            naziv: "Dablin",
            drzava: "Ujedinjena Kraljevstva",
            kontinent: "Evropa",
            fotografija: "../assets/dablin.jpg"
        },{
            naziv: "Brisel",
            drzava: "Belgija",
            kontinent: "Evropa",
            fotografija: "../assets/brisel.jpg"
        },{
            naziv: "Krakov",
            drzava: "Poljska",
            kontinent: "Evropa",
            fotografija: "../assets/krakov.jpg"
        },{
            naziv: "Stokholm",
            drzava: "Švedska",
            kontinent: "Evropa",
            fotografija: "../assets/stokholm.jpg"
        },{
            naziv: "Ljubljana",
            drzava: "Slovenija",
            kontinent: "Evropa",
            fotografija: "../assets/ljubljana.jpg"
        },{
            naziv: "Kijev",
            drzava: "Ukrajina",
            kontinent: "Evropa",
            fotografija: "../assets/kijev.jpg"
        },{
            naziv: "Salcburg",
            drzava: "Austrija",
            kontinent: "Evropa",
            fotografija: "../assets/salcburg.jpg"
        },{
            naziv: "Mumbaj",
            drzava: "Indija",
            kontinent: "Azija",
            ...
            drzava: "Japan",
            kontinent: "Azija",
            fotografija: "../assets/kjoto.jpg"
        },{
            naziv: "Marakeš",
            drzava: "Maroko",
            kontinent: "Afrika",
            fotografija: "../assets/marakes.jpg"
        },{
            naziv: "Sankt Peterburg",
            drzava: "Rursija",
            kontinent: "Azija",
            fotografija: "../assets/sanktpeterburg.jpg"
        },{
            naziv: "San Francisko",
            drzava: "Sjedinjene Američke Države",
            kontinent: "Severna Amerika",
            fotografija: "../assets/sanfrancisko.jpg"
        },{
            naziv: "Kingston",
            drzava: "Jamajka",
            kontinent: "Severna Amerika",
            fotografija: "../assets/kingston.jpg"
        },{
            naziv: "Nju Orleans",
            drzava: "Sjedinjene Američke Države",
            kontinent: "Severna Amerika",
            fotografija: "../assets/njuorleans.jpg"
        },{
            naziv: "San Hose",
            drzava: "Kostarika",
            kontinent: "Severna Amerika",
            fotografija: "../assets/sanhose.jpg"
        },{
            naziv: "Nju Delhi",
            drzava: "Indija",
            kontinent: "Azija",
            fotografija: "../assets/njudelhi.jpg"
        },{
            naziv: "Adelejd",
            drzava: "Australija",
            kontinent: "Australija sa okeanijom",
            fotografija: "../assets/adelejd.jpg"
        },{
            naziv: "Bukurešt",
            drzava: "Rumunija",
            kontinent: "Evropa",
            fotografija: "../assets/bukurest.jpg"
        },{
            naziv: "Manila",
            drzava: "Filipini",
            kontinent: "Azija",
            fotografija: "../assets/manila.jpg"
        }
    ];

tipSmestaja = ["1/1", "1/2", "1/3", "1/2+1", "1/3+1", "1/4"];
...
for (let index = 0; index < lokacije.length; index++) {
    ...
    tipIndex = generateRandom(tipSmestaja.length);
    kategorija = generateRandom(5) + 1;
    internet = generateRandom(2) == 1 ? true : false; 
    tv = generateRandom(2) == 1 ? true : false; 
    ac = generateRandom(2) == 1 ? true : false; 
    frizider = generateRandom(2) == 1 ? true : false; 
    sef = generateRandom(2) == 1 ? true : false;
    brojSlika = generateRandom(4) + 3; 
    slike = [];
    for (let index = 0; index < brojSlika; index++) {
        brSlike = generateRandom(30);
        naziv = "../assets/smestaj" + brSlike + ".jpg";
        slike.push(naziv);
    }
    ime = dictionary[generateRandom(dictionary.length)] + " " + dictionary[generateRandom(dictionary.length)];
...
mestaPolaska = ["Beograd", "Novi Sad", "Niš", "Kragujevac"];
vremenaPovratka = ["jutarnjim", "prepodnevnim", "popodnevnim", "večernjim"];
...
for (let index = 0; index < 50000; index++) {
    ...
    opis = []
    if(prevoz[prevozIndex] == 'Avion')
        opis.push("Polazak sa aerodroma u " + polazakVreme +". "+opisDana);
    else
        opis.push("Polazak sa perona u " + polazakVreme +". "+opisDana);
    for (let index = 0; index < trajanje - 2; index++) {
        opis.push(opisDana);        
    }
    opis.push(opisDana + " Dolazak u "+polazakMesto+ " u "+povratakVreme + " časovima.");
